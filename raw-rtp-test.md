...
gst-launch-1.0 -v \
  ...
  rtph264pay config-interval=-1 aggregate-mode=zero-latency ! application/x-rtp,encoding-name=H264,clock-rate=90000,media=video,payload=96 ! \
  rtpulpfecenc percentage=20 pt=122 ! udpsink host=127.0.0.1 port=5000
```
...
```bash
gst-launch-1.0 rtpbin latency=500 fec-decoders='fec,0="rtpst2022-1-fecdec\ size-time\=1000000000";' name=rtp udpsrc port=5002 caps="application/x-rtp, payload=96" ! queue ! rtp.recv_fec_sink_0_0 udpsrc port=5004 caps="application/x-rtp, payload=96" ! queue ! rtp.recv_fec_sink_0_1 \
